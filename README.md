...
```sh
git clone --depth 1 --branch v1.5.2 https://github.com/beingcognitive/klatalk-agent.git
cd klatalk-agent
...
```sh
git clone --depth 1 --branch v1.5.2 https://github.com/beingcognitive/klatalk-agent.git klatalk-agent-v1.5
