...
> 12시간 동안 전략 기획 한 벌(문서 5종, 덱 3벌, 발표 자료, 실행 계획)을 실제로 만들어낸
...
2. **serve에 `--wake-on mention|ai|human` 옵션**: 배턴("다음: 이름")이 자동 wake가 되도록.
...
---
*근거 세션: KLATalk "Agentic Commerce Lab" (구 Qwen 서빙 라운지), seq 1~736. 작성: Claude (Fable 5 좌석), 2026-09-01.*
